...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_UnitFactory_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("CreateEnemy", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CreateEnemy_0);
        ...
        static StackObject* CreateEnemy_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);


            var result_of_this_method = ETModel.UnitFactory.CreateEnemy();
